...
public class Jogador {
    ...
    public void restauraEstado(int estadoJ) {
        if (estadoJ < 0 || estadoJ > this.memento.size() - 1) {
            throw new IllegalArgumentException("Estadi do jogador inválido");
        }
        this.estado = this.memento.get(estadoJ);
    }
